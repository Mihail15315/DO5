...
*   **Создание и настройка файла конфигурации на локальной машине**
    ...
    *   ![Вывод содержимого созданного локального файла конфигурации nginx.conf на хост-машине](/screens/02_local_nginx_config.png)
...
*   **Экспорт контейнера и остановка служб**
    ...
    *   После завершения экспорта исходный работающий контейнер был остановлен:
    ...
    ```
    *   ![Вызов команд экспорта файловой системы контейнера в архив container.tar и последующей остановки контейнера](screenshots/05_export_and_stop.png)
